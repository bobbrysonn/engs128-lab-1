...
The majority of the post-lab report will consist of consolidating, organizing, and explaining the design documentation deliverables in each task. You and your partner are expected to work together on this--each lab group will submit one report.
...
For the Canvas submission, you will upload:
...
Before submitting the assignment, please double-check the following: 
...
3. Separate sections for each of the **design tasks** that provide detailed descriptions and documentation (the list of design documents to submit for each task is consolidated in the section below). 
	* Start each section with a short description of how this design component works.
 	* Add the paper designs (schematics, FSMs, block diagrams, design calculations)
  	* Add the annotated RTL schematics generated by Vivado Elaboration. *How well did the generated RTL schematic compare to your paper design? Please explain any discrepancies.*
   	* At a high level, explain what simulations you ran. *How did they help you evaluate the efficacy of your design? Include well-annotated simulation waveforms to support your argument.*
...
The paper designs, RTL schematics, block diagrams, and annotated waveform diagrams listed at the end of each task should all be included as figures in the report. **As a general rule of thumb, every image/figure in the report should have a short (1-2 sentences) description of what the reader should deduce from looking at it.** A summary of the design deliverables is consolidated below:
